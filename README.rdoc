...
* Criar um novo usuário manualmente no server via rails console (ex: `u = User.create! email: 'cassiano@tagview.com.br', password: 12345678`)
...
* Copiar os dados da app gerados pelo oauth2 provider (id e secret) para `app/controllers/resources_controller.rb` no client
